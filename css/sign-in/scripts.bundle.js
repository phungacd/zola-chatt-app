...
var KTDialer = function(e, t) {
    ...
    if (e) {
        var i = {
            ...
            l = function() {
                return KTEventHandler.trigger(n.element, "kt.dialer.decrease", n), n.inputElement.value = n.value - n.options.step, console.log("dec:" + n.inputElement.value), s(), KTEventHandler.trigger(n.element, "kt.dialer.decreased", n), n
            },
            s = function() {
                KTEventHandler.trigger(n.element, "kt.dialer.change", n), n.value = u(n.inputElement.value), console.log("min:" + n.options.min), null !== n.options.min && n.value < n.options.min && (n.value = n.options.min, console.log("reset: min")), null !== n.options.max && n.value > n.options.max && (n.value = n.options.max), n.inputElement.value = d(n.value), n.inputElement.dispatchEvent(new Event("change")), KTEventHandler.trigger(n.element, "kt.dialer.changed", n)
            },
            u = function(e) {
                return e = e.replace(/[^0-9.-]/g, "").replace(/(\..*)\./g, "$1").replace(/(?!^)-/g, "").replace(/^0+(\d)/gm, "$1"), e = parseFloat(e), isNaN(e) && (e = 0), e
            },
            d = function(e) {
                return console.log("val:" + e), n.options.prefix + parseFloat(e).toFixed(n.options.decimals) + n.options.suffix
            },
            c = function(e) {
